...
const getIndicFeatureForLigature = (components: Character[], scriptTag: string): string => {
    ...
    clonedCharsByUnicode.forEach(char => {
        ...
        if (char.glyphClass !== 'virtual' && hasLigatureComponents && !char.gsub) {
            if (isIndic) {
                ...
                // Infer specific Indic feature (akhn, abvs, etc.)
                char.gsub = getIndicFeatureForLigature(components, scriptTag);
            } else {
