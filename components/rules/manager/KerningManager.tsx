    ...
    return (
        <div className="space-y-6">
             <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <h3 className="text-lg font-bold mb-4 text-gray-800 dark:text-white">Add Spacing Pair</h3>
                <div className="flex flex-wrap items-end gap-3">
                    <div className="flex-1 min-w-[140px]">
                        <label className="text-xs font-semibold text-gray-500 uppercase mb-1 block">Left</label>
                        <SmartGlyphInput value={left} onChange={setLeft} characterSets={characterSets} groups={groups} placeholder="e.g. T" />
                    </div>
                    <div className="flex-1 min-w-[140px]">
                        <label className="text-xs font-semibold text-gray-500 uppercase mb-1 block">Right</label>
                        <SmartGlyphInput value={right} onChange={setRight} characterSets={characterSets} groups={groups} placeholder="e.g. o" />
                    </div>
                    <div className="w-24">
                         <label className="text-xs font-semibold text-gray-500 uppercase mb-1 block">Value (Opt)</label>
            ...
            <div>
                <h3 className="text-lg font-bold mb-3 text-gray-800 dark:text-white">Recommended Pairs</h3>
                ...
                {kerning.length === 0 && <p className="text-center text-gray-400 py-8 italic">No pairs defined.</p>}
            </div>
        </div>
    );
};
