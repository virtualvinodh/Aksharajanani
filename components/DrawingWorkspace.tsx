...
const DrawingWorkspace: React.FC<DrawingWorkspaceProps> = ({ characterSets, onSelectCharacter, onAddGlyph, onAddBlock, drawingProgress }) => {
    ...
    const { dispatch: characterDispatch, positioningGroupNames, allCharsByName, markAttachmentRules, positioningRules } = useProject();
    ...
    const handleBatchAccept = useCallback(() => {
        if (filterMode !== 'autoGenerated' || !metrics || !settings) return;
        ...
        filteredFlatList.forEach(char => {
            ...
            if (char.position) {
                ...
                if (baseChar && markChar && baseChar.unicode !== undefined && markChar.unicode !== undefined) {
                    ...
                    if (!newMarkPositioningMap.has(key)) {
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden relative">
            <DrawingWorkspaceHeader 
                ...
                onAcceptAutoGenerated={handleBatchAccept}
            />
