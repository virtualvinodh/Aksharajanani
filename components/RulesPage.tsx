...
const AutoGeneratedBlockCard: React.FC<{
    ...
    strokeThickness: number;
    scriptTag: string;
}> = ({ featureTag, allCharsByUnicode, glyphDataMap, onMoveUp, onMoveDown, isFirst, isLast, allCharsByName, strokeThickness, scriptTag }) => {
    const { t } = useLocale();
    ...
    const rules = useMemo(() => {
        ...
        return getAutoGeneratedRules(allCharsByUnicode, glyphDataMap, featureTag, scriptTag);
    }, [isExpanded, allCharsByUnicode, glyphDataMap, featureTag, scriptTag]);

    const count = useMemo(() => {
        return getAutoGeneratedRules(allCharsByUnicode, glyphDataMap, featureTag, scriptTag).length;
    }, [allCharsByUnicode, glyphDataMap, featureTag, scriptTag]);
